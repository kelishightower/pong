    	...
    	if event.type == pygame.QUIT:
        	carryOn = False
            	...
            	if event.key == pygame.K_x: #Pressing the x Key will quit the game
                 	carryOn = False
	# ifnorming what occur for game over (main operation) before what occurs before/without game over
	...
	if carryOn:
    	...
    	if ball_posy > PADDLE1_y4 and ball_posy < PADDLE1_y4 + 70:
        	if ball_posx <= PADDLE1_x4 + 10:
            	ball_change_posx = ball_change_posx * -1
    	#if ball_posx2 <= PADDLE1_x4 + 10 and ball_posx2 <= PADDLE1_x4 + 70:
        	#ball_change_posx = ball_change_posx * -1
    	#if ball_posx3 <= PADDLE1_x4 + 10 and ball_posx3 <= PADDLE1_x4 + 70:
        	#ball_change_posx3 = ball_change_posx3 * -1
